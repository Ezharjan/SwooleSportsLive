...
//        $accessKeyId = "USE_YOUR_OWN_KEY_PLS"; // AccessKeyId
        $accessKeyId = "USE_YOUR_OWN_KEY_PLS"; // AccessKeyId

//        $accessKeySecret = "USE_YOUR_OWN_KEY_PLS"; // AccessKeySecret
        $accessKeySecret = "USE_YOUR_OWN_KEY_PLS"; // AccessKeySecret
    ...
    public static function sendSms($phone, $code)
    {
        ...
        $request->setSignName("singwa娱乐app");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_75915048");
